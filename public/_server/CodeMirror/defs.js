var terndefs_f6783a0a_522d_417e_8407_94c67b692e50 = [
    {
        ...
        getComputedStyle: {
            '!type':
                'fn(node: +Element, pseudo?: string) -> Element.prototype.style',
        ...
        CanvasRenderingContext2D: {
            ...
            resetClip: 'fn()',
            fillText:
                'fn(text: string, x: number, y: number, maxWidth: number)',
            strokeText:
                'fn(text: string, x: number, y: number, maxWidth: number)',
            ...
            getImageData:
                'fn(sx: number, sy: number, sw: number, sh: number) -> ?',
            ...
            quadraticCurveTo:
                'fn(cpx: number, cpy: number, x: number, y: number)',
            bezierCurveTo:
    ...
    },
    {
        ...
        Array: {
            ...
            prototype: {
                ...
                splice: {
                    '!type':
                        'fn(pos: number, amount: number, newelt?: ?) -> [?]',
                ...
                forEach: {
                    '!type':
                        'fn(f: fn(elt: ?, i: number, array: +Array), context?: ?)',
                    '!effects': ['call !0 this=!1 !this.<i> number !this'],
                    '!doc': '每个数组元素执行一次提供的功能.'
                },
                map: {
                ...
                fill: {
                    '!type':
                        'fn(value: ?, start?: number, end?: number) -> !this',
        ...
        String: {
            ...
            prototype: {
                ...
                padStart: {
                    '!type':
                        'fn(targetLength: number, padString?: string) -> string',
                ...
                split: {
                    '!type':
                        'fn(pattern?: string|+RegExp, limit?: number) -> [string]',
                ...
                replace: {
                    '!type':
                        'fn(pattern: string|+RegExp, replacement: string) -> string',
                    '!doc': '返回一个新字符串,该字符串的某个或所有匹配项都由替换项替换.该模式可以是字符串或RegExp,并且替换项可以是字符串或每个匹配项将调用的函数. '
                },
                endsWith: {
                    '!type':
                        'fn(searchString: string, position?: number) -> bool',
        ...
        core: {
            ...
            control: {
                ...
                drawHero: {
                    ...
                    '!type':
                        'fn(status?: string, offset?: number, frame?: number)'
                },
                pauseBgm: {
                    '!doc': '暂停背景音乐的播放',
                    '!type': 'fn()'
                ...
                setHeroLoc: {
                    ...
                    '!type':
                        'fn(name: string, value: string|number, noGather?: bool)'
                },
                getLvName: {
                ...
                registerReplayAction: {
                    ...
                    '!type':
                        'fn(name: string, func: fn(action?: string) -> bool)'
                },
                checkAutosave: {
                    '!doc': '实际将自动存档写入存储',
                    '!type': 'fn()'
                ...
                moveDirectly: {
                    '!doc': '瞬间移动',
                    '!type':
                        'fn(destX?: number, destY?: number, ignoreSteps?: number)'
                },
                clearRouteFolding: {
                    '!doc': '清空录像折叠信息',
                    '!type': 'fn()'
                ...
                removeSwitch: {
                    '!doc': '删除某个独立开关',
                    '!type':
                        'fn(x: number, y: number, floorId: string, name: string)'
                },
                removeSwitch: {
                    '!doc': '判定某个独立开关',
                    '!type':
            ...
            icons: {
                ...
                getTilesetOffset: {
                    ...
                    '!type':
                        'fn(id?: string) -> {image: ?, x: number, y: number}'
                },
                getClsFromId: {
                    '!doc': '根据ID获得其图标类型',
            ...
            items: {
                ...
                useItem: {
                    ...
                    '!type':
                        'fn(itemId: string, noRoute?: bool, callback?: fn())'
                },
                hasEquip: {
            ...
            utils: {
                ...
                cloneArray: {
                    ...
                    '!type':
                        'fn(data?: [number]|[[number]]) -> [number]|[[number]]'
                },
                setLocalForage: {
                    '!doc': '往数据库写入一段数据',
                    '!type':
                ...
                myconfirm: {
                    ...
                    '!type':
                        'fn(hint: string, yesCallback?: fn(), noCallback?: fn())'
                },
                calValue: {
            ...
            actions: {
                ...
                keyUp: {
                    ...
                    '!type':
                        'fn(keyCode: number, altKey?: bool, fromReplay?: bool)'
                },
                ondown: {
                    '!doc': '点击（触摸）事件按下时',
                    '!type': 'fn(loc: {x: number, y: number, size: number})'
            ...
            maps: {
                ...
                noPass: {
                    ...
                    '!type':
                        'fn(x: number, y: number, floorId?: string) -> bool'
                },
                drawAnimate: {
                ...
                getMapArray: {
                    ...
                    '!type':
                        'fn(floorId?: string, noCache?: bool) -> [[number]]'
                },
                getMapNumber: {
                    '!doc': '获得事件层某个点的数字',
                    '!type':
                ...
                compressMap: {
                    '!doc': '压缩地图',
                    '!type':
                        'fn(mapArr: [[number]], floorId?: string) -> [[number]]'
                },
                enemyExists: {
                    '!doc': '某个点是否存在（指定的）怪物',
                    '!type':
                ...
                setBlockFilter: {
                    '!doc': '设置某个点图块的特效',
                    '!type':
                        'fn(filter?: ?, x?: number, y?: number, floorId?: string)'
                },
                decompressMap: {
                    '!doc': '解压缩地图',
                    '!type':
                ...
                drawBg: {
                    ...
                    '!type':
                        'fn(floorId?: string, ctx?: CanvasRenderingContext2D)'
                },
                showBlock: {
                ...
                drawThumbnail: {
                    ...
                    '!type':
                        'fn(floorId?: string, blocks?: [block], options?: ?)'
                },
                hideBlockByIndex: {
                    '!doc': '根据图块的索引来隐藏图块',
                    '!type': 'fn(index?: number, floorId?: string)'
            ...
            ui: {
                ...
                setOpacity: {
                    ...
                    '!type':
                        'fn(name: string|CanvasRenderingContext2D, opacity: number)'
                },
                ...
                setFillStyle: {
                    ...
                    '!type':
                        'fn(name: string|CanvasRenderingContext2D, style: string)'
                },
                drawText: {
                    '!doc': '地图中间绘制一段文字',
                ...
                drawConfirmBox: {
                    ...
                    '!type':
                        'fn(text: string, yesCallback?: fn(), noCallback?: fn())'
                },
                drawUIEventSelector: {
                ...
                relocateCanvas: {
                    '!doc': '重新定位一个自定义画布',
                    '!type':
                        'fn(name: string, x: number, y: number, useDelta: bool)'
                },
                rotateCanvas: {
                ...
                setFont: {
                    ...
                    '!type':
                        'fn(name: string|CanvasRenderingContext2D, font: string)'
                },
                drawChoices: {
                    '!doc': '绘制一个选项界面',
                    '!type':
                ...
                setTextAlign: {
                    ...
                    '!type':
                        'fn(name: string|CanvasRenderingContext2D, align: string)'
                }
            },
            enemys: {
                ...
                getSpecialHint: {
                    ...
                    '!type':
                        'fn(enemy: string|enemy, special: number) -> string'
                },
                getSpecialText: {
                ...
                hasEnemyLeft: {
                    ...
                    '!type':
                        'fn(enemyId?: string, floorId?: string|[string]) -> bool'
                }
            },
            events: {
                ...
                startEvents: {
                    '!doc': '开始执行一系列自定义事件',
                    '!type':
                        'fn(list?: [?], x?: number, y?: number, callback?: fn())'
                },
                setHeroIcon: {
                ...
                doEvent: {
                    '!doc': '执行一个自定义事件',
                    '!type':
                        'fn(data?: ?, x?: number, y?: number, prefix?: string)'
                },
                win: {
                    '!doc': '游戏获胜事件',
                ...
                registerSystemEvent: {
                    ...
                    '!type':
                        'fn(type: string, func: fn(data?: ?, callback?: fn()))'
                },
                startGame: {
                ...
                openDoor: {
                    ...
                    '!type':
                        'fn(x: number, y: number, needKey?: bool, callback?: fn())'
                },
                setEnemy: {
                ...
                closeDoor: {
                    ...
                    '!type':
                        'fn(x: number, y: number, id: string, callback?: fn())'
                },
                eventMoveHero: {
                ...
                gameOver: {
                    ...
                    '!type':
                        'fn(ending?: string, fromReplay?: bool, norank?: bool)'
                },
                useFly: {
                    '!doc': '点击楼层传送器时的打开操作',
                    '!type': 'fn(fromUserAction?: bool)'
            ...
            plugin: {
                ...
                removeMaps: {
                    '!doc': '删除某一些楼层；删除后不会存入存档，不可浏览地图也不可飞到。<br/>fromId: 开始删除的楼层ID<br/>toId: 删除到的楼层编号；可选，不填则视为fromId<br/>例如：core.plugin.removeMap.removeMaps("MT1", "MT300") 删除MT1~MT300之间的全部层<br/>core.plugin.removeMap.removeMaps("MT10") 只删除MT10层',
                    '!type': 'fn(fromId: string, toId?: string)'
                },
                resumeMaps: {
                    '!doc': '恢复某一些被删除楼层。<br/>fromId: 开始恢复的楼层ID<br/>toId: 恢复到的楼层编号；可选，不填则视为fromId<br/>例如：core.plugin.removeMap.resumeMaps("MT1", "MT300") 恢复MT1~MT300之间的全部层<br/>core.plugin.removeMap.resumeMaps("MT10") 只删恢复MT10层',
                    '!type': 'fn(fromId: string, toId?: string)'
                },
                autoRemoveMaps: {
                    '!doc': '根据楼层分区信息自动砍层与恢复',
